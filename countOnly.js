...
const countOnly = function (allItems, itemsToCount) {
  ...
  for (let arrItems of allItems) {
    if (itemsToCount[arrItems]) {
      //) && itemsToCount[arrItems] === 'true'  this is incorrect because your compairing string true to value of true, instead you are already checking for true or false in the truthy statement
      if (result[arrItems]) {
        result[arrItems] += 1;
      } else {
        result[arrItems] = 1;
